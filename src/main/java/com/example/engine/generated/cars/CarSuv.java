...
public class CarSuv {
    ...
    public String toString() {
        ...
        sb.append(CarSuv.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CarSuv) == false) {
            return false;
        }
        CarSuv rhs = ((CarSuv) other);
